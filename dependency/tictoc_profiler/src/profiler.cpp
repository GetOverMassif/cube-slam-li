...
void Profiler::print_aggregated(std::ostream& os) {
  ...
  os << "\n\n";
  os << std::setw(20) << std::setfill(' ') << "Description";
  os << std::setw(10) << std::setfill(' ') << "Calls";
  os << std::setw(10) << std::setfill(' ') << "Total ms";
  os << std::setw(10) << std::setfill(' ') << "Avg ms";
  os << std::setw(10) << std::setfill(' ') << "Min ms";
  os << std::setw(10) << std::setfill(' ') << "Max ms";
  os << "\n";
  for (size_t i=0; i < aggregated.size(); ++i) {
    AggregatedProfilerEntry& ag(aggregated[i]);
    os << std::setw(20) << std::setfill(' ') << ag.name;
    os << std::setw(10) << std::setprecision(5) << std::setfill(' ') << ag.num_calls;
    os << std::setw(10) << std::setprecision(5) << std::setfill(' ') << ag.total_ms;
    os << std::setw(10) << std::setprecision(5) << std::setfill(' ') << ag.avg_ms;
    os << std::setw(10) << std::setprecision(5) << std::setfill(' ') << ag.min_ms;
    os << std::setw(10) << std::setprecision(5) << std::setfill(' ') << ag.max_ms;
    os << "\n";
  }
  os << "\n";
}
